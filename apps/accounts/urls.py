...
urlpatterns = [
    ...
    path("export/modal/", views.export_users_modal_view, name="export_users_modal"),
    path("export/initiate/", views.export_users_initiate_view, name="initiate_export_users"),
